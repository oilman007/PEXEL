...
namespace GeoEdit
{
    ...
    public class Pillar
    {
        ...
        {
            return Point3D(0).ToString() + " " + Point3D(9999).ToString();
        }
        ...
        {
            return new GeoEdit.Point3D(a.Y * b.Z - b.Y * a.Z, a.Z * b.X - b.Z * a.X, a.X * b.Y - b.X * a.Y);
        }
