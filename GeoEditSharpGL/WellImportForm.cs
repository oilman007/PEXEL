...
namespace GeoEdit
{
    public partial class WellImportForm : Form
    {
        ...
        {
            int value;
            return int.TryParse(txtValue, out value) && 1 <= value && value <= 4;
        }
        ...
        public int X
        {
            get
            {
                return int.Parse(this.textBox_x.Text) - 1;
            }
        }
        ...
        public int Y
        {
            get
            {
                return int.Parse(this.textBox_y.Text) - 1;
            }
        }
        ...
        public int TVD
        {
            get
            {
                return int.Parse(this.textBox_tvd.Text) - 1;
            }
        }
        ...
        public int MD
        {
            get
            {
                return int.Parse(this.textBox_md.Text) - 1;
            }
        }
